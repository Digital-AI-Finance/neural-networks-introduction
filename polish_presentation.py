"""
Polish Neural Networks presentation with improvements:
1. Fix overfull slides (trim content)
2. Simplify summary slide
3. Add section dividers
4. Convert remaining slides to Definition-Example format
5. Restore appendix marker
"""
...
# Configuration
SOURCE_FILE = "20251123_1753_neural_networks_layouts.tex"
PREVIOUS_DIR = Path("previous")
PREVIOUS_DIR.mkdir(exist_ok=True)

# Generate new filename with timestamp
timestamp = datetime.now().strftime("%Y%m%d_%H%M")
NEW_FILE = f"{timestamp}_neural_networks_polished.tex"
...
\usebeamerfont{{title}}\Large {title}\par
\end{{beamercolorbox}}
\vspace{{0.5cm}}
{{\normalsize {subtitle}}}
\vfill
...
# Define all the polished slides
...
# Slide 2: Prediction Challenge (Definition-Example)
SLIDE_PREDICTION_CHALLENGE = r"""
...
# Slide 3: What We Need (Definition-Example)
SLIDE_WHAT_WE_NEED = r"""
...
SECTION_FOUNDATIONS = SECTION_DIVIDER.format(
    title="Part 1: Foundations",
    subtitle="From biological neurons to artificial intelligence"
)

# Slide 4: Nature's Computer (trimmed)
SLIDE_BIOLOGY = r"""
...
# Slide 6: Mathematical Model (trimmed)
SLIDE_MATH_MODEL = r"""
...
# Slide 7: Chart - Single Neuron
SLIDE_CHART_NEURON = r"""
...
SECTION_BUILDING_BLOCKS = SECTION_DIVIDER.format(
    title="Part 2: Building Blocks",
    subtitle="Activation functions and their role in learning"
)

# Slide 8: Activation Functions (trimmed)
SLIDE_ACTIVATION = r"""
...
SECTION_ARCHITECTURE = SECTION_DIVIDER.format(
    title="Part 3: Network Architecture",
    subtitle="Building layers of intelligence"
)

# Slide 12: Network Architecture (trimmed)
SLIDE_ARCHITECTURE = r"""
...
# Slide 14: Forward Propagation (trimmed)
SLIDE_FORWARD = r"""
...
# Slide 15: Chart - Forward Prop
SLIDE_CHART_FORWARD = r"""
...
SECTION_LEARNING = SECTION_DIVIDER.format(
    title="Part 4: Learning Process",
...
SECTION_APPLICATION = SECTION_DIVIDER.format(
    title="Part 5: Application",
    subtitle="Putting it all together with market prediction"
)

# Slide 20: Market Prediction (trimmed)
SLIDE_MARKET = r"""
...
# Slide 22: Training Results (trimmed)
SLIDE_RESULTS = r"""
...
# Slide 23: Chart - Results
SLIDE_CHART_RESULTS = r"""
...
# Slide 25: When to Use (Definition-Example)
SLIDE_WHEN_TO_USE = r"""
...
# Slide 26: Limitations & Ethics (Definition-Example)
SLIDE_ETHICS = r"""
...
full_document = (
    ...
    SLIDE_MATH_MODEL +
    SLIDE_CHART_NEURON +
    SECTION_BUILDING_BLOCKS +
    SLIDE_ACTIVATION +
    SLIDE_CHART_ACTIVATION +
    SLIDE_LIMITATION +
    SLIDE_CHART_XOR +
...
print("  - Trimmed 6 overfull slides")
print("  - Simplified summary slide")
print("  - Added 5 section dividers")
print("  - Converted intro/when-to-use/ethics to Definition-Example")
print("  - Restored appendix marker")
