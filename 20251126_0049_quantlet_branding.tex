...
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/11_problem_visualization/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/11_problem_visualization/}{\includegraphics[width=0.6cm]{11_problem_visualization/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/11_problem_visualization/}{\tiny\texttt{\textcolor{gray}{11\_problem\_visualization}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/11_problem_visualization/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/11_problem_visualization/}{\includegraphics[width=0.6cm]{11_problem_visualization/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/12_decision_boundary_concept/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/12_decision_boundary_concept/}{\includegraphics[width=0.6cm]{12_decision_boundary_concept/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/12_decision_boundary_concept/}{\tiny\texttt{\textcolor{gray}{12\_decision\_boundary\_concept}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/12_decision_boundary_concept/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/12_decision_boundary_concept/}{\includegraphics[width=0.6cm]{12_decision_boundary_concept/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/13_neuron_decision_maker/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/13_neuron_decision_maker/}{\includegraphics[width=0.6cm]{13_neuron_decision_maker/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/13_neuron_decision_maker/}{\tiny\texttt{\textcolor{gray}{13\_neuron\_decision\_maker}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/13_neuron_decision_maker/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/13_neuron_decision_maker/}{\includegraphics[width=0.6cm]{13_neuron_decision_maker/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/01_biological_neuron/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/01_biological_neuron/}{\includegraphics[width=0.6cm]{01_biological_neuron/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/01_biological_neuron/}{\tiny\texttt{\textcolor{gray}{01\_biological\_neuron}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/01_biological_neuron/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/01_biological_neuron/}{\includegraphics[width=0.6cm]{01_biological_neuron/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/02_single_neuron_function/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/02_single_neuron_function/}{\includegraphics[width=0.6cm]{02_single_neuron_function/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/02_single_neuron_function/}{\tiny\texttt{\textcolor{gray}{02\_single\_neuron\_function}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/02_single_neuron_function/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/02_single_neuron_function/}{\includegraphics[width=0.6cm]{02_single_neuron_function/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/03_activation_functions/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/03_activation_functions/}{\includegraphics[width=0.6cm]{03_activation_functions/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/03_activation_functions/}{\tiny\texttt{\textcolor{gray}{03\_activation\_functions}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/03_activation_functions/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/03_activation_functions/}{\includegraphics[width=0.6cm]{03_activation_functions/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/14_sigmoid_saturation/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/14_sigmoid_saturation/}{\includegraphics[width=0.6cm]{14_sigmoid_saturation/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/14_sigmoid_saturation/}{\tiny\texttt{\textcolor{gray}{14\_sigmoid\_saturation}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/14_sigmoid_saturation/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/14_sigmoid_saturation/}{\includegraphics[width=0.6cm]{14_sigmoid_saturation/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/04_linear_limitation/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/04_linear_limitation/}{\includegraphics[width=0.6cm]{04_linear_limitation/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/04_linear_limitation/}{\tiny\texttt{\textcolor{gray}{04\_linear\_limitation}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/04_linear_limitation/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/04_linear_limitation/}{\includegraphics[width=0.6cm]{04_linear_limitation/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/15_boundary_evolution/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/15_boundary_evolution/}{\includegraphics[width=0.6cm]{15_boundary_evolution/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/15_boundary_evolution/}{\tiny\texttt{\textcolor{gray}{15\_boundary\_evolution}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/15_boundary_evolution/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/15_boundary_evolution/}{\includegraphics[width=0.6cm]{15_boundary_evolution/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/05_network_architecture/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/05_network_architecture/}{\includegraphics[width=0.6cm]{05_network_architecture/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/05_network_architecture/}{\tiny\texttt{\textcolor{gray}{05\_network\_architecture}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/05_network_architecture/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/05_network_architecture/}{\includegraphics[width=0.6cm]{05_network_architecture/qr_code.png}}
...
\begin{frame}[t]{Feature Hierarchy (Part 1): From Raw Data to Patterns}
\begin{columns}[T]
\column{0.48\textwidth}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/06_forward_propagation/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/06_forward_propagation/}{\includegraphics[width=0.6cm]{06_forward_propagation/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/06_forward_propagation/}{\tiny\texttt{\textcolor{gray}{06\_forward\_propagation}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/06_forward_propagation/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/06_forward_propagation/}{\includegraphics[width=0.6cm]{06_forward_propagation/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/07_loss_landscape/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/07_loss_landscape/}{\includegraphics[width=0.6cm]{07_loss_landscape/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/07_loss_landscape/}{\tiny\texttt{\textcolor{gray}{07\_loss\_landscape}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/07_loss_landscape/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/07_loss_landscape/}{\includegraphics[width=0.6cm]{07_loss_landscape/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/08_gradient_descent/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/08_gradient_descent/}{\includegraphics[width=0.6cm]{08_gradient_descent/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/08_gradient_descent/}{\tiny\texttt{\textcolor{gray}{08\_gradient\_descent}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/08_gradient_descent/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/08_gradient_descent/}{\includegraphics[width=0.6cm]{08_gradient_descent/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/17_overfitting_underfitting/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/17_overfitting_underfitting/}{\includegraphics[width=0.6cm]{17_overfitting_underfitting/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/17_overfitting_underfitting/}{\tiny\texttt{\textcolor{gray}{17\_overfitting\_underfitting}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/17_overfitting_underfitting/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/17_overfitting_underfitting/}{\includegraphics[width=0.6cm]{17_overfitting_underfitting/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/09_market_prediction_data/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/09_market_prediction_data/}{\includegraphics[width=0.6cm]{09_market_prediction_data/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/09_market_prediction_data/}{\tiny\texttt{\textcolor{gray}{09\_market\_prediction\_data}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/09_market_prediction_data/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/09_market_prediction_data/}{\includegraphics[width=0.6cm]{09_market_prediction_data/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/10_prediction_results/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/10_prediction_results/}{\includegraphics[width=0.6cm]{10_prediction_results/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/10_prediction_results/}{\tiny\texttt{\textcolor{gray}{10\_prediction\_results}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/10_prediction_results/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/10_prediction_results/}{\includegraphics[width=0.6cm]{10_prediction_results/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/19_confusion_matrix/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/19_confusion_matrix/}{\includegraphics[width=0.6cm]{19_confusion_matrix/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/19_confusion_matrix/}{\tiny\texttt{\textcolor{gray}{19\_confusion\_matrix}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/19_confusion_matrix/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/19_confusion_matrix/}{\includegraphics[width=0.6cm]{19_confusion_matrix/qr_code.png}}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/20_trading_backtest/}{\includegraphics[width=0.8cm]{logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/20_trading_backtest/}{\includegraphics[width=0.6cm]{20_trading_backtest/qr_code.png}}
};
% URL text (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.2cm] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/20_trading_backtest/}{\tiny\texttt{\textcolor{gray}{20\_trading\_backtest}}}
};
\end{tikzpicture}
...
% Logo (clickable)
\node[anchor=south east,xshift=-0.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/20_trading_backtest/}{\includegraphics[width=0.8cm]{quantlet_tools/logo/quantlet.png}}
};
% QR Code (clickable)
\node[anchor=south east,xshift=-1.3cm,yshift=0.6cm,opacity=0.5] at (current page.south east) {
  \href{https://github.com/QuantLet/neural-networks-introduction/tree/main/20_trading_backtest/}{\includegraphics[width=0.6cm]{20_trading_backtest/qr_code.png}}
